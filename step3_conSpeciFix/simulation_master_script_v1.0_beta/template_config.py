...
#PATH_TO_OUT = "/stor/work/Ochman/yli19/projects/conSpeciFix/step3_Flaviviruses/runs_final/run15_USUV/_conspecifix/database/"
PATH_TO_OUT = ""
...
USEARCH_PATH = '/stor/work/Ochman/yli19/projects/conSpeciFix/usearch6.1.544_i86linux32' 
MAFFT_PATH = 'mafft'
MCL_PATH = 'mcl'
RAXML_PATH = '/usr/bin/raxmlHPC-PTHREADS'
...
MAX_RAXML_DISTANCE_ALLOWED = 1000 # no strains will be removed from too distant
#CORE_GENOME_PERCENT = .85
CORE_GENOME_PERCENT = .001 # changed to really small so no genome region will be removed
