...
tab=read.table('/stor/work/Ochman/yli19/projects/conSpeciFix/step3_Flaviviruses/runs/run8b_YFV_1000and0.05_beta_modified_genomes_removed/_conspecifix/database/User_spec/kmeans.txt')
listOfValues= tab$V3
...
png('/stor/work/Ochman/yli19/projects/conSpeciFix/step3_Flaviviruses/runs/run8b_YFV_1000and0.05_beta_modified_genomes_removed/_conspecifix/database/User_spec/kmeans.png' ,width = 6,
  height    = 6,
  units     = "in",
  res       = 200)
...
write(strainsForRemoval,ncol=1,file='/stor/work/Ochman/yli19/projects/conSpeciFix/step3_Flaviviruses/runs/run8b_YFV_1000and0.05_beta_modified_genomes_removed/_conspecifix/database/User_spec/for_removal.txt')
