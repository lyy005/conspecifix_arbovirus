...
my $tot_a_ratio = $tot_a / ($tot_a + $tot_t + $tot_c + $tot_g);
my $tot_t_ratio = $tot_t / ($tot_a + $tot_t + $tot_c + $tot_g);
my $tot_c_ratio = $tot_c / ($tot_a + $tot_t + $tot_c + $tot_g);
my $tot_g_ratio = $tot_g / ($tot_a + $tot_t + $tot_c + $tot_g);

my $tot_cg_ratio = ($tot_c + $tot_g) / ($tot_a + $tot_t + $tot_c + $tot_g);
my $tot_at_ratio = 1 - $tot_cg_ratio;

print "GC content: $tot_cg_ratio\tAT content: $tot_at_ratio\nA content: $tot_a_ratio\; T content: $tot_t_ratio\; C content: $tot_c_ratio\; G content: $tot_g_ratio\;\n";
